...
app.controller('MyCtrl', function($scope, $http) {    
    ...
    $scope.gridOptions = {
        ...
        showFilter: true,
        columnDefs: [
{field: 'idorder', displayName: 'idorder', width: "10%"},
{field: 'agentsname', displayName: 'Торговый агент', width: "10%"},
{field: 'clientid', displayName: 'Код клиента', width: "10%"},
{field: 'clientsnameord', displayName: 'Название точки', width: "10%"},
{field: 'adresslocord', displayName: 'Адресс точки', width: "10%"},
{field: 'docdateorder', displayName: 'Дата заявки', width: "10%", enableCellEdit: true},
{field: 'goodsname', displayName: 'Товар', width: "10%"},
{field: 'loadingdate', displayName: 'Дата вывоза', width: "10%", enableCellEdit: true},
{field: 'paytypename', displayName: 'форма опаты', width: "10%"},
{field: 'itemcountorder', displayName: 'Заказов за период', width: "10%"},
{field: 'itemcountout', displayName: 'Вывоз в 24ч', width: "10%"},
{field: 'clientsname', displayName: 'Вывоз позже', width: "10%"},
{field: 'idout', displayName: 'номер р/н', width: "10%"},
